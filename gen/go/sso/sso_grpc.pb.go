...
func (c *authClient) UpdateAccess(ctx context.Context, in *UpdateAccessRequest, opts ...grpc.CallOption) (*UpdateAccessResponse, error) {
	out := new(UpdateAccessResponse)
	err := c.cc.Invoke(ctx, "/auth.Auth/UpdateAccess", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAuthServer) UpdateAccess(context.Context, *UpdateAccessRequest) (*UpdateAccessResponse, error) {
...
func _Auth_UpdateAccess_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/auth.Auth/UpdateAccess",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
