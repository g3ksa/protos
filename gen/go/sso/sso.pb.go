...
func (x *UpdateAccessRequest) GetRefreshToken() string {
	if x != nil {
		return x.RefreshToken
	}
	return ""
...
func (x *UpdateAccessResponse) GetAccessToken() string {
	if x != nil {
		return x.AccessToken
	}
	return ""
...
var file_sso_sso_proto_rawDesc = []byte{
	...
	0x73, 0x22, 0x39, 0x0a, 0x13, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x41, 0x63, 0x63, 0x65, 0x73,
	...
	0x72, 0x65, 0x66, 0x72, 0x65, 0x73, 0x68, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x38, 0x0a, 0x14,
	0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x41, 0x63, 0x63, 0x65, 0x73, 0x73, 0x52, 0x65, 0x73, 0x70,
	...
	0x73, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x32, 0xef, 0x01, 0x0a, 0x04, 0x41, 0x75, 0x74, 0x68, 0x12,
	...
	0x65, 0x12, 0x45, 0x0a, 0x0c, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x41, 0x63, 0x63, 0x65, 0x73,
	0x73, 0x12, 0x19, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x41,
	0x63, 0x63, 0x65, 0x73, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1a, 0x2e, 0x61,
	0x75, 0x74, 0x68, 0x2e, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x41, 0x63, 0x63, 0x65, 0x73, 0x73,
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x17, 0x5a, 0x15, 0x63, 0x61, 0x73, 0x65,
	0x67, 0x75, 0x72, 0x75, 0x2e, 0x73, 0x73, 0x6f, 0x2e, 0x76, 0x31, 0x3b, 0x73, 0x73, 0x6f, 0x76,
...
var file_sso_sso_proto_goTypes = []interface{}{
	...
	(*UpdateAccessRequest)(nil),  // 6: auth.UpdateAccessRequest
	(*UpdateAccessResponse)(nil), // 7: auth.UpdateAccessResponse
}
var file_sso_sso_proto_depIdxs = []int32{
	0, // 0: auth.Auth.Register:input_type -> auth.RegisterRequest
	2, // 1: auth.Auth.Login:input_type -> auth.LoginRequest
	4, // 2: auth.Auth.Logout:input_type -> auth.LogoutRequest
	6, // 3: auth.Auth.UpdateAccess:input_type -> auth.UpdateAccessRequest
	...
	7, // 7: auth.Auth.UpdateAccess:output_type -> auth.UpdateAccessResponse
...
func file_sso_sso_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_sso_sso_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UpdateAccessRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_sso_sso_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UpdateAccessResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
